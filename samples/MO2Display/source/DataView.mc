...
class DataView extends Ui.View {
    ...
    function onUpdate(dc)
    {
        ...
        fWidth = dc.getTextWidthInPixels(text, font);
        dc.drawText(width/4 - fWidth/2, height/3, font, text, Gfx.TEXT_JUSTIFY_LEFT);

        dc.setColor( Gfx.COLOR_ORANGE, Gfx.COLOR_TRANSPARENT );
        font = mUnitFont;
        text = "g/dl";
        dc.drawText(width/4 + fWidth/2 + marginLeft, height/3, font, text, Gfx.TEXT_JUSTIFY_LEFT);
        ...
        fWidth = dc.getTextWidthInPixels(text, font);
        dc.drawText((width * 3 / 4) - fWidth/2, height/3, font, text, Gfx.TEXT_JUSTIFY_LEFT);
        ...
        text = "Current";
        fWidth = dc.getTextWidthInPixels(text, font);
        dc.drawText(width/4 - fWidth/2, height * 3 / 4 - marginMid, font, text, Gfx.TEXT_JUSTIFY_LEFT);

        dc.setColor( Gfx.COLOR_BLUE, Gfx.COLOR_TRANSPARENT );
        font = mDataFont;
        text = mSensor.data.currentHemoPercent.format("%.1f");
        fWidth = dc.getTextWidthInPixels(text, font);
        dc.drawText(width/4 - fWidth/2, height*5/6, font, text, Gfx.TEXT_JUSTIFY_LEFT);

        dc.setColor( Gfx.COLOR_ORANGE, Gfx.COLOR_TRANSPARENT );
        font = mUnitFont;
        text = "%";
        dc.drawText(width/4 + fWidth/2 + marginLeft, height*5/6, font, text, Gfx.TEXT_JUSTIFY_LEFT);
        ...
        text = "Previous";
        fWidth = dc.getTextWidthInPixels(text, font);
        dc.drawText((width * 3 / 4) - fWidth/2, height * 3 / 4 - marginMid, font, text, Gfx.TEXT_JUSTIFY_LEFT);

        dc.setColor( Gfx.COLOR_BLUE, Gfx.COLOR_TRANSPARENT );
        font = mDataFont;
        text = mSensor.data.previousHemoPercent.format("%.1f");
        fWidth = dc.getTextWidthInPixels(text, font);
        dc.drawText((width * 3 / 4) - fWidth/2, height*5/6, font, text, Gfx.TEXT_JUSTIFY_LEFT);

        dc.setColor( Gfx.COLOR_ORANGE, Gfx.COLOR_TRANSPARENT );
        font = mUnitFont;
        text = "%";
        dc.drawText((width * 3 / 4) + fWidth/2 + marginLeft, height*5/6, font, text, Gfx.TEXT_JUSTIFY_LEFT);
